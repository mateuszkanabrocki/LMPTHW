...
setup(
    name='do',
    version='1.0',
    description='Testing argv and argparse modules.',
    author='Mateusz Kanabrocki',
    author_email='mateusz.kanabrocki@gmail.com',
    packages=['do_argparse', 'do_argv'],  #same as name
    install_requires=['nose'], #external packages as dependencies
    url='https://github.com/mateuszkanabrocki/LMPTHW/tree/master/?',
    download_url='https://github.com/mateuszkanabrocki/LMPTHW/tree/master/?',
